package watt.testemenuinferiorabas;
...
import watt.horizontalscrollmenulibrary.custom_views.HorizontalScrollMenuView;
import watt.horizontalscrollmenulibrary.extras.MenuItem;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        horizontal_menu.addItem("Clientes", R.drawable.clients);
        horizontal_menu.addItem("Pedidos", R.drawable.orders);
        horizontal_menu.addItem("Ferramentas", R.drawable.settings);
